...
![example workflow](https://github.com/starainrt/go-mysql/actions/workflows/ci.yml/badge.svg)
![gomod version](https://img.shields.io/github/go-mod/go-version/go-mysql-org/go-mysql/master)
[![Go Reference](https://pkg.go.dev/badge/github.com/starainrt/go-mysql.svg)](https://pkg.go.dev/github.com/starainrt/go-mysql)
...
import (
	"github.com/starainrt/go-mysql/canal"
)
...
You can see [go-mysql-elasticsearch](https://github.com/starainrt/go-mysql-elasticsearch) for how to sync MySQL data into Elasticsearch.
...
import (
	...
	"github.com/starainrt/go-mysql/server"
)
...
import (
	...
	"github.com/starainrt/go-mysql/driver"
)
...
A custom driver name can be set via build options: `-ldflags '-X "github.com/starainrt/go-mysql/driver.driverName=gomysql"'`.
...
```
replace github.com/siddontang/go-mysql => github.com/starainrt/go-mysql v1.13.0
```

This can be done by running this command:
```
go mod edit -replace=github.com/siddontang/go-mysql=github.com/starainrt/go-mysql@v1.13.0
```
...
go-mysql was started by @siddontang and has many [contributors](https://github.com/starainrt/go-mysql/graphs/contributors)
